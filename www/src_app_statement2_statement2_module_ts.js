...
let Statement2Page = class Statement2Page {
    constructor(platform, alertController, router, storage, modalController, loadingController, datePipe, api, toast, sortingService, exportService, currencyService, cdr) {
...
Statement2Page.propDecorators = {
    accountPopover: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_11__.ViewChild, args: ['accountPopover',] }]
};
Statement2Page = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
