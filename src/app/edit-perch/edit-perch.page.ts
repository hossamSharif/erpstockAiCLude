...
isSelectAll: boolean = false;
  ...
  this.route.queryParams.subscribe(params => {
    ...
    if (params && params.payInvo && !this.dataInitialized) {
      ...
      // Safety net: recalculate totals from itemList to ensure consistency
      this.getTotal();
...
async updateInvo(){
  ...
  try {
    // Offline-aware update via OfflineDataService
    const result = await this.offlineData.updatePurchaseInvoice(invoiceWithItems);
