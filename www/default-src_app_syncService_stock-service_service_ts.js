"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_syncService_stock-service_service_ts"],{

/***/ 17158:
/*!******************************************************!*\
  !*** ./src/app/syncService/stock-service.service.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StockServiceService": () => (/* binding */ StockServiceService)
/* harmony export */ });
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ 53975);
...
let StockServiceService = class StockServiceService {
    constructor(storage, http) {
        this.storage = storage;
        this.http = http;
        this.api = 'https://erp.hosamdev.com/myapi/api/';
        this.LogHistoryArr = [];
        ...
        this.tswia_details = [];
        this.items = [];
        this.itemsResources = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject([]);
        this.notiftemp = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject([]);
        this.currentItem = this.itemsResources.asObservable();
        this.currentNotif = this.notiftemp.asObservable();
        // this.setConfig()
    }
    changeItems(items) {
        ...
        setInterval(() => {
            this.storage.get('lastSync').then((response) => {
                if (response) {
                    ...
                    this.getLogHistory(this.store_info.id, this.year.id, moment__WEBPACK_IMPORTED_MODULE_1__(this.lastSync).locale('en').format('YYYY-MM-DD HH:mm:ss')).subscribe(data => {
    ...
    bothItemAndAccount(status) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            yield this.getStockItems();
            yield this.getSalesAccount(status);
            yield this.afterSync();
        });
    }
    afterSync() {
        ...
        let dt = new Date();
        this.lastSync = moment__WEBPACK_IMPORTED_MODULE_1__(dt).locale('en').format('YYYY-MM-DD HH:mm:ss');
        this.storage.set("lastSync", this.lastSync).then((response) => {
        });
        this.LogHistoryLocalArr = this.LogHistoryLocalArr.sort((a, b) => (+a.id > +b.id) ? -1 : 1);
        this.storage.set('LogHistoryLocal', this.LogHistoryLocalArr).then((response) => {
...
StockServiceService.ctorParameters = () => [
    { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_0__.Storage },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__.HttpClient }
];
StockServiceService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
//# sourceMappingURL=default-src_app_syncService_stock-service_service_ts.js.map