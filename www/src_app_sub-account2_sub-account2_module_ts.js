...
let SubAccount2Page = class SubAccount2Page {
    constructor(storage, alertController, modalController, loadingController, datePipe, api, toast, router, sortingService, exportService, currencyService) {
...
SubAccount2Page.propDecorators = {
    actionsPopover: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_11__.ViewChild, args: ['actionsPopover',] }]
};
SubAccount2Page = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
