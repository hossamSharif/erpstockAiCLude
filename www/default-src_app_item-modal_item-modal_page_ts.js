...
let ItemModalPage = class ItemModalPage {
    constructor(loadingController, api, modalController, toast, alertController) {
        ...
        this.colSettingpr = { id: true, item_name: true, model: true, part_no: true, min_qty: true, brand: true, pay_price: true, perch_price: true, item_unit: true, item_desc: true, item_parcode: true, profit: true, instock: true, total: true, lastSold: true, aliasEn: true, category_name: true };
