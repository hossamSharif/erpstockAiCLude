...
AnalyticsDashboardPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! chart.js */ 9775);
...
let AnalyticsDashboardPage = class AnalyticsDashboardPage {
    constructor(api, loadingController, toast, datePipe, storage) {
        this.api = api;
    ...
    createMockSalesPurchaseChart() {
        ...
        this.salesPurchaseChartInstance = new chart_js__WEBPACK_IMPORTED_MODULE_4__.Chart(ctx, config);
    }
    createMockCashFlowChart() {
        ...
        this.cashFlowChartInstance = new chart_js__WEBPACK_IMPORTED_MODULE_4__.Chart(ctx, config);
    }
    createMockStockValueChart() {
        ...
        this.stockValueChartInstance = new chart_js__WEBPACK_IMPORTED_MODULE_4__.Chart(ctx, config);
    }
...
AnalyticsDashboardPage.propDecorators = {
    salesPurchaseChart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: ['salesPurchaseChart', { static: false },] }],
    cashFlowChart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: ['cashFlowChart', { static: false },] }],
    stockValueChart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: ['stockValueChart', { static: false },] }]
};
AnalyticsDashboardPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
