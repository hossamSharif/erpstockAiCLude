...
let LoginPage = class LoginPage {
    constructor(api, storage, toast, loadingController, authenticationService, router) {
        this.api = api;
    ...
    loginUser() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            if (this.USER_INFO.user_name == "" || this.USER_INFO.password == "") {
                ...
                yield this.storage.set('STORE_INFO', this.store_info);
                yield this.storage.set('company', this.company);
                // Subscribe to auth state changes to handle redirect
                const authSubscription = this.authenticationService.authState.subscribe((isAuthenticated) => (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
                    if (isAuthenticated) {
                        // Cleanup subscription
                        authSubscription.unsubscribe();
                        // Navigate to analytics dashboard
                        yield this.router.navigate(['/analytics-dashboard'], { replaceUrl: true });
                    }
                }));
                // Trigger login
